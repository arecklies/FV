...
import {
  ...
  appendDatenBauabgang,
  appendAnsprechpartner,
} from "./statistik-helpers.js";
import crypto from "node:crypto";

/**
 * build-0426: statistik.bauabgang.0426
 *
 * XSD: xbau-nachrichten-statistik.xsd
 * Rechtsgrundlage: § 1 (2) Nr. 4 HBauStatG
 * Statistikmeldung anlaesslich eines Bauabgangs.
 *
 * Pflichtfelder: bezug (BezugStatistikmeldung), allgemeineAngaben, datenBauabgang
 * Optional: ansprechpartner
 */
export function buildStatistik0426(params) {
  ...
  const root = doc
    .ele(NS_XBAU, "statistik.bauabgang.0426")
  ...
  appendDatenBauabgang(root, params.datenBauabgang);
