---
name: meta-optimize
description: Reflektiert vergangene Interaktionen, identifiziert Reibungspunkte im Agenten-/Skill-/Rules-System und schlägt konkrete Verbesserungen an .claude/rules/* oder .claude/commands/* vor. Änderungen werden nie automatisch angewendet – immer Human-in-the-Loop. Aufruf mit /meta-optimize
---
...
- Alle Dateien unter `.claude/commands/` die in der letzten Arbeitsphase betroffen waren
...
- **Skill-Verbesserung**: Optimierung der Prompt-Struktur in `.claude/commands/*.md`
