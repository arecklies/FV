...
VALUES (
  gen_random_uuid(),
  'a1111111-1111-4111-8111-111111111111',
  jsonb_build_object('sub', 'a1111111-1111-4111-8111-111111111111', 'email', 'demo-sb@bauaufsicht.example'),
  'email',
  'a1111111-1111-4111-8111-111111111111',
  now(), now(), now()
);
...
VALUES (
  gen_random_uuid(),
  'a2222222-2222-4222-8222-222222222222',
  jsonb_build_object('sub', 'a2222222-2222-4222-8222-222222222222', 'email', 'demo-rl@bauaufsicht.example'),
  'email',
  'a2222222-2222-4222-8222-222222222222',
  now(), now(), now()
);
...
INSERT INTO tenant_members (tenant_id, user_id, role) VALUES
  ('a0000000-0000-4000-8000-000000000001', 'a1111111-1111-4111-8111-111111111111', 'sachbearbeiter'),
  ('a0000000-0000-4000-8000-000000000001', 'a2222222-2222-4222-8222-222222222222', 'referatsleiter');
...
INSERT INTO vorgaenge (id, tenant_id, aktenzeichen, verfahrensart_id, bundesland, bauherr_name, bauherr_anschrift, grundstueck_adresse, grundstueck_flurstueck, bezeichnung, workflow_schritt_id, zustaendiger_user_id, eingangsdatum, created_by, extra_felder) VALUES
  ('c0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0001', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Müller, Hans',      'Hauptstr. 1, 40822 Mettmann',    'Berliner Str. 45, 40822 Mettmann',      'Flur 3, 412/5', 'Neubau Einfamilienhaus',        'eingegangen',              'a1111111-1111-4111-8111-111111111111', '2026-03-20', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0002', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Schmidt, Petra',    'Ringstr. 12, 40878 Ratingen',    'Am Markt 8, 40878 Ratingen',            'Flur 7, 88/2',  'Anbau Doppelgarage',            'vollstaendigkeitspruefung', 'a1111111-1111-4111-8111-111111111111', '2026-03-01', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0003', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Weber, Thomas',     'Schulstr. 5, 40699 Erkrath',     'Industriestr. 23, 40699 Erkrath',       'Flur 2, 156/1', 'Umbau Lagerhalle zu Büro',      'beteiligung',              'a1111111-1111-4111-8111-111111111111', '2026-02-15', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0004', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Fischer, Anna',     'Talstr. 77, 40822 Mettmann',     'Düsseldorfer Str. 100, 40822 Mettmann', 'Flur 5, 302/8', 'Neubau Mehrfamilienhaus 6 WE', 'pruefung',                 'a1111111-1111-4111-8111-111111111111', '2025-12-10', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0005', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Becker, Klaus',     'Gartenweg 3, 40764 Langenfeld',  'Solinger Str. 55, 40764 Langenfeld',    'Flur 1, 45/12', 'Dachgeschossausbau',            'bescheid_entwurf',         'a1111111-1111-4111-8111-111111111111', '2025-09-01', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0006', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Krause, Sabine',    'Moselstr. 8, 40699 Erkrath',     'Hochdahler Str. 22, 40699 Erkrath',     'Flur 4, 78/3',  'Neubau Gewerbegebäude',         'freizeichnung',            'a2222222-2222-4222-8222-222222222222', '2025-11-15', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0007', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Hoffmann, Martin',  'Parkstr. 15, 40878 Ratingen',    'Bahnhofstr. 1, 40878 Ratingen',         'Flur 9, 221/6', 'Nutzungsänderung Laden→Praxis', 'zustellung',               'a1111111-1111-4111-8111-111111111111', '2025-10-20', 'a1111111-1111-4111-8111-111111111111', '{}'),
  ('c0000000-0000-4000-8000-000000000008', 'a0000000-0000-4000-8000-000000000001', '2026/BG-0008', 'b0000000-0000-4000-8000-000000000001', 'NW', 'Lange, Christina',  'Seeweg 42, 40764 Langenfeld',    'Itterstr. 7, 40764 Langenfeld',         'Flur 6, 134/9', 'Carport mit Abstellraum',       'abgeschlossen',            'a1111111-1111-4111-8111-111111111111', '2025-08-01', 'a1111111-1111-4111-8111-111111111111', '{}');
...
WHERE vorgang_id = 'c0000000-0000-4000-8000-000000000005';
